...
* Updated by        : Elias
*
* Support mail      : ripagood@gmail.com
*
* This little library is a port from TWI_Master by Atmel using the IAR Compiler
* to a AVR-GCC for use in freeRTOS
*
****************************************************************************/
...
#include "FreeRTOS.h"
volatile unsigned char TWI_buf[ TWI_BUFFER_SIZE ];    // Transceiver buffer
